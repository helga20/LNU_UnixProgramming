...
namespace Task37
{
    ...
    {	    	
        static void Main(string[] args)
        {
        	if (!(args.Length == 1))
		{
			Console.WriteLine("Task37: wrong number of arguments");
			Console.WriteLine("Try 'Task37 --help' for more information");
		}
		else if(Equals(args[0], "--help"))
		{
			Console.WriteLine("Usage: Task37 Path");
      		Console.WriteLine("Select 100 most used words in HTML text  that you specify by path or URL");
		...
		else
		{
			...
			{
				string filenameurl = "filefromurl.html";
